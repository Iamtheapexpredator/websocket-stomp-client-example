...
setup(
    ...
    name='websocket-stomp-client',  # Required
    ...
    author="Luke Danielson",  # Optional
    author_email="danielsonlukea@gmail.com",  # Optional
    ...
    install_requires=[
        'stomper (>=0.4.1,<0.5.0)',
        'websockets (>=7.0,<8.0)',
        'websocket-client (>=0.54.0,<0.55.0)',
    ],  # Optional
    ...
    entry_points={  # Optional
        'console_scripts': [
            'lint=pylint websocket_stomp_client',
        ],
    },
